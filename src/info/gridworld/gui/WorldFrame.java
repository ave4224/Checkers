...
public class WorldFrame<T> extends JFrame {
    ...
    public WorldFrame(World<T> world) {
        ...
        if (world instanceof CheckersWorld) {
            display = new CheckersGridPanel(displayMap, resources, (CheckersWorld) world);
        } else {
     ...
     * @param resource the resource whose .text/.title strings should be used in
     * the dialog
     */
    ...
    private void showAboutPanel() {
        String html = MessageFormat.format(resources
                .getString("dialog.about.text"), new Object[]{resources.getString("version.id")});
